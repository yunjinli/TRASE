...
if __name__ == '__main__':
    ...
    for video in videos:
        ...
        if args.scale != 1:
            do_system(f"ffmpeg -i {video} -filter:v scale=iw/{args.scale}:ih/{args.scale} -start_number 0 {images_path}/{cam_name}_%04d.png")
        else:
    ...
    if not args.extract_image_only:  
        ...
        if args.scale != 1:
            ...
            cams = sorted(set([im[10:15] for im in images]))
        ...
        print(f'[INFO] Original: H = {H}, W = {W}, fl = {fl}')
